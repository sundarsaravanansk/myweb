        ...
        <>
            <nav className='left-0 z-[999] w-full text-center ml-auto mr-auto fixed top-[30px]' >
                        ...
                        <div className='flex justify-between py-2 lg:py-3 px-5 lg:px-10 z-[999] relative rounded-[20px]'>
                            ...
                            <div className='lg:hidden flex items-center'>
                                <button onClick={() => { setOpen(!open) }}>
                                    ...
                                    /> */}
                                    <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 18L20 18" stroke="#fff" stroke-width="2" stroke-linecap="round"></path><path d="M4 12L20 12" stroke="#fff" stroke-width="2" stroke-linecap="round"></path><path d="M4 6L20 6" stroke="#fff" stroke-width="2" stroke-linecap="round"></path></svg>
                                </button>
                ...
                <div className='fixed bottom-10 right-5 flex'>
                   ...
                   <div>
                   <a href="/cv/SUNDAR RESUME.pdf" target='_blank'>
                    <Image 
