            ...
            <div className='flex flex-wrap -mx-4'>
                ...
                <div className='w-[100%] md:h-[100vh] md:w-2/4 flex-auto ver-cen' >
                    <div className="text-white mb-14 md:mb-0">
                        <div className="mb-4">
                            <h2 className='font-h2-lg bg-gradient-to-r from-fuchsia-500 via-sky-500 to-cyan-400 inline-block text-transparent bg-clip-text'>CONTACT</h2>
                        </div>
                        ...
                        <div className='mt-4'>
                            ...
                            <div><h2 className='Subtitle'>Address</h2></div>
                            </div>
                        ...
                        <div className='relative  mt-4'>
                            ...
                            <div> <h2 className='Subtitle'>Phone</h2></div>
                            </div>
                            <div className='mt-2 lg:mt-3 '>
